...
form.addEventListener('submit', function (e) {
    ...
    fetch(url).then((response) => {
        ...
        if (weatherMain == 'Clear') {
            image.src = "C:\Users\Asfak\Pictures\clear.png"
            myWeatherContainer.style.backgroundColor = '#ec6e4c'
        }
        if (weatherMain == 'Clouds') {
            image.src = "C:\Users\Asfak\Pictures\cloud.png"
            myWeatherContainer.style.backgroundColor = '#86d3d3'
        }
        if (weatherMain == 'Rain') {
            image.src = "C:\Users\Asfak\Pictures\rain.png"
            myWeatherContainer.style.backgroundColor = '#494bcf'
        }
        if (weatherMain == 'Drizzle') {
            image.src = "sprinkler_FILL0_wght400_GRAD0_opsz48.png"
            myWeatherContainer.style.backgroundColor = '#8ecfcf'
        }
        if (weatherMain == 'Haze') {
            image.src = "foggy_FILL0_wght400_GRAD0_opsz48.png"
